    ...
    <div className="mx-auto flex h-[calc(100vh-8rem)] w-full max-w-3xl flex-col">
      ...
      <div className="mt-3 flex gap-2 items-end">
        <textarea
          ...
          className="flex-1 resize-none overflow-y-auto max-h-52 bg-muted border border-border rounded-lg px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-ring disabled:opacity-60"
        />
        <button

...
export default async function SoccSyncPage() {
  ...
  return (
    <>
      ...
      <p className="muted">
        Upload a Survey Ops export. CCM matches each project to a survey by its{' '}
        <strong>PR#####</strong> code and records its current SOCC stage (e.g.{' '}
        <em>Fielding</em>) on the survey. This is <strong>status only</strong> — it never
        changes credits, balances, or any report. Projects with no matching survey are

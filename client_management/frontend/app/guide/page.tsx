  ...
  return (
    <div className="guide">
      ...
      <ul>
        ...
        <li><strong>Attach documents to a contract</strong>: expand a contract to see its <strong>📎 Documents</strong>. Contract managers can upload signed PDFs, SOWs or invoices (PDF/Office/image/CSV/text, up to 8 MB) and remove them; anyone who can see the client can download. Files download rather than open in-page for safety, and removing one archives it (recoverable) rather than destroying it.</li>
